...
insert into member(ID,PW,name,nickname,address,phone_number) values('aaaaa','1234','Ã¢ÈÆ','nickname1','address1','01012341234');
insert into member(ID,PW,name,nickname,address,phone_number) values('bbbbb','2234','ÁöÇö','nickname2','address2','01022341234');
insert into member(ID,PW,name,nickname,address,phone_number) values('ccccc','1234','¸íÁØ','nickname3','address1','01032341234');
insert into member(ID,PW,name,nickname,address,phone_number) values('ddddd','1234','»ó¿ì','nickname4','address1','01032341234');
insert into member(ID,PW,name,nickname,address,phone_number) values('eeeee','1234','ÇöÃ¶','nickname5','address1','01032341234');
insert into member(ID,PW,name,nickname,address,phone_number) values('fffff','1234','±âÈ¯','nickname6','address1','01032341234');
